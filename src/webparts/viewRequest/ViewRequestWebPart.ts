...
export default class ViewRequestWebPart extends BaseClientSideWebPart<
  IViewRequestWebPartProps
> {
        ...
        for (var index = 0; index < allItems.length; index++) {
          ...
          $("#tblBody").append(
            "<tr><td>" +
              ...
              "</td><td>" +
              element.RequestedWarrantyTime +
              "</td><td>" +
              element.PNforZAS +
              "</td><td>" +
              element.EstimatedcostJOD +
              "</td><td>" +
              element.EstimatedcostEUR +
              '</td><td><a target="_blank" href="' +
              element.Specifications +
              '">' +
              element.Specifications +
              '</a></td><td><a target="_blank" href="' +
              element.EstimatedcostEUR +
              '">' +
              element.EstimatedcostEUR +
              "</a></td></tr>"
